...
public class TestEntrega3 {
	...
	public void setUp() throws Exception {
		...
		String[][] asientos = {
				...
				{ "01202022220298-2", "528.81", "P", "V", "D", "", "07:00",
						"08:00", "USA", "USH", "20/12/2012", "21/12/2012" },
						{ "01202022220298-2", "528.81", "P", "V", "D", "", "07:00",
							"08:00", "USA", "USH", "20/12/2012", "21/12/2012" },
							{ "01202022220298-2", "528.81", "P", "V", "D", "", "07:00",
								"08:00", "USA", "USH", "20/12/2012", "21/12/2012" }};
		...
		usuarioVip = new Usuario("Federico Gabriel", "Lopez Luksenberg",
				"36747013", new Vip(), aterrizar);
		usuarioEstandar = new Usuario("Marcelo Javier", "Lopez Luksenberg",
				"36747012", new Estandar(), aterrizar);
		otroUsuarioEstandar = new Usuario("Eugenio", "Lopez Luksenberg",
				"28543567", new Estandar(), aterrizar);
		usuarioNoPago = new Usuario("Andres Francisco", "Lopez Luksenberg",
				"33783548", new NoPaga(), aterrizar);
	...
	//TODO Sacar este test
	@Test
	public void testItinerariosDeUnaEscala() {
		List<Itinerario> itinerarios = aterrizar
				.obtenerItinerariosQueSatisfaganUnViajeDeDosEscalas("EZE",
						"USH", null, usuarioVip, lanchita);
		for (Itinerario in : itinerarios) {
			for (int i = 0; i < 3; i++) {
				System.out.println(in.getAsientos().get(i).getOrigen() + " "
						+ in.getAsientos().get(i).getDestino());
			}
		}
	}
